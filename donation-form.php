...
<body class="donation-page">
  ...
  <div class="form-wrapper">
    <form action="./database/add-donor.php" method="POST">
      <h3>Donation Form</h3>
      <?php
        if (isset($_GET['error'])) {
          ...
          echo "<p style='color : green'>Blood have been successfully donated</p>";
        }
      ?>
      <label for="donor_name">Donor Name</label><br />
      <input type="text" name="donor_name" placeholder="Enter Donor Name here" /><br /><br />
